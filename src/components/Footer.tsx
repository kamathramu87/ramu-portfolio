      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            {/* KVK */}
            <div>
              <p className="text-xs font-semibold text-gray-300 mb-2">Ramu Dataengineering Services</p>
              <ul className="space-y-1 text-xs text-gray-500">
                <li>Software ontwikkelaar · Eenmanszaak</li>
                <li>KVK-nummer: 86199390</li>
                <li>Vestigingsnummer: 000052189473</li>
                <li>Claudiusstraat 11, 2275CV Voorburg</li>
              </ul>
            </div>
          </div>
